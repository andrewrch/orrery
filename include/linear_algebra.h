...
void vec3_norm(vec3 a, vec3 b);
void vec3_scale(vec3 r, vec3 const a, float s);
void vec3_cross(vec3 r, vec3 a, vec3 b);
float vec3_mag(vec3 const r);

/* mat4x4 functions */
void mat4x4_identity(mat4x4 r);
void mat4x4_add(mat4x4 r, mat4x4 const a, mat4x4 const b);
void mat4x4_sub(mat4x4 r, mat4x4 const a, mat4x4 const b);
void mat4x4_translate(mat4x4 a, float x, float y, float z);
